...
df_bowtie = pd.DataFrame(index = samples, columns = colnames) #index is rows i think
with open ("C:/Users/fhartley/Documents/Project/CRISPR miRNA/6 - Analysis/cluster/bowtie/dmf811.o73915120") as stats:
lines = stats.readlines()
    ...
    with open (file, "r") as bowtieoutput:
        ...
        ab = a[0].split(":")[1] #take line 1 of the output (0), then split in by the colon. Which splits it in half in this case, and takes the second half [1]
        abc = int(ab)
